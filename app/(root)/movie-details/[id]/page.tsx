  ...
  return (
    ...
    ></div>
        ...
        <Link href="/">
            ...
            <div className="flex flex-col md:flex-row justify-between gap-12 items-center my-12 mx-6">
                ...
                <div className='text-white flex flex-col gap-4 justify-center'>
                    <h2 className='text-center text-3xl'>{data.title}</h2>
        ...
        <div className='text-white bg-gray-950 z-10 px-6'>
            ...
            <p className='text-lg px-6 py-1 border-b-1 border-gray-800'><span className='text-amber-300'>Budget: </span>${data.budget.toLocaleString()}</p>
            <p className='text-lg px-6 py-3 border-b-1 border-gray-800'><span className='text-amber-300'>Revenue: </span>${data.revenue.toLocaleString()}</p>
            <p className='text-lg px-6 py-3 border-b-1 border-gray-800'><span className='text-amber-300'>Runtime: </span>{data.runtime}</p>
